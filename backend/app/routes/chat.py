...
from app.schemas.message import MessageCreate, MessageResponse, ChatMessagesResponse, PublicMessageResponse
...
@router.post("/public/message", response_model=PublicMessageResponse)
async def send_public_message(message_data: MessageCreate):
    """
    Public trial endpoint: send a message and get AI response without authentication.
