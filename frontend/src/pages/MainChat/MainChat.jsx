...
const MainChat = () => {
  ...
  const [assistantMode, setAssistantMode] = useState("default");
            ...
            {messages.length === 0 ? (
              <div className="text-center py-20">
                <div className="mb-6 flex items-center justify-center">
                  <div className="w-24 h-24 rounded-3xl bg-black border border-black flex items-center justify-center shadow-sm">
                    <img
                ...
                <p className="text-gray-500 mb-8 max-w-2xl mx-auto">
                  Ask me anything about Islam, Quran, Hadith, or request
                  Islamic-themed illustrations. I'm here to help you learn!
                </p>
          ...
          <div className="max-w-4xl mx-auto">
            {attachedFile && (
              <div className="mb-2 flex items-center gap-2 text-sm text-gray-600">
                <span className="px-2 py-1 bg-gray-100 rounded-lg border border-gray-200">
                  {attachedFile.name}
                </span>
                <button
                  type="button"
            ...
            >
              ...
              >
                ...
                {isPlusOpen && (
                  <div className="absolute left-0 bottom-12 w-56 bg-[#e8f5e9] text-gray-800 rounded-2xl shadow-xl border border-[#d7ead9] p-2 space-y-1 z-50">
                    <button
                      type="button"
                      onClick={handleAttachClick}
                      className="w-full flex items-center gap-2 px-3 py-2 text-sm rounded-lg hover:bg-white/70"
                    >
                      <span>📎</span>
                    ...
                    <div className="h-px bg-[#cfe5d2] my-1" />
                    <button
                      type="button"
                      onClick={() => handleSelectMode("thinking")}
                      className={`w-full flex items-center gap-2 px-3 py-2 text-sm rounded-lg hover:bg-white/70 ${
                        assistantMode === "thinking" ? "bg-white/60" : ""
                      }`}
                    >
                      <span>💡</span>
                      <span>Thinking</span>
                    ...
                    <button
                      type="button"
                      onClick={() => handleSelectMode("deep-research")}
                      className={`w-full flex items-center gap-2 px-3 py-2 text-sm rounded-lg hover:bg-white/70 ${
                        assistantMode === "deep-research" ? "bg-white/60" : ""
                      }`}
                    >
                      <span>🔬</span>
                    ...
                    <button
                      type="button"
                      onClick={() => handleSelectMode("shopping-research")}
                      className={`w-full flex items-center gap-2 px-3 py-2 text-sm rounded-lg hover:bg-white/70 ${
                        assistantMode === "shopping-research"
                          ? "bg-white/60"
                          : ""
                      }`}
                    >
                    ...
                    <button
                      ...
                      className="w-full flex items-center justify-between gap-2 px-3 py-2 text-sm rounded-lg hover:bg-white/70"
                    >
                      <span>More</span>
                      <span>›</span>
                    </button>
